...
const SingleRecipePage = () => {
  ...
  const { allRecipes, singleRecipe } = useSelector(
  ...
  return (
    <Box p={4} w="85%" m="auto" overflow={"hidden"} my="120px">
      ...
      <HStack my="10px">
        ...
        <Button
          onClick={() => handleAddToBookmark(singleRecipe.id)}
      ...
      <Box my="10px" position={"relative"}>
        <Grid
          ...
          gap={{ base: 4, lg: 10 }}
        >
          {/* Display All Ingredients Image */}
          <Box position="relative">
            <Heading>All Ingredients</Heading>
            <Image
              src={`https://api.spoonacular.com/recipes/${singleRecipe.id}/ingredientWidget.png?apiKey=${apiKey}`}
            />
          </Box>

          {/* Display Nutrition Label Image */}
        ...
        {/* Display list of extended ingredients */}
